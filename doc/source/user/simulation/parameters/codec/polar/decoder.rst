...
""""""""""""""""""
   ...
   :Type: text
   :Allowed values: ``SC`` ``SCAN`` ``SCF`` ``DSCF`` ``SCL`` ``SCL_MEM`` ``ASCL``
                    ``ASCL_MEM`` ``CHASE`` ``ML``
   :Default: ``SC``
...
+--------------+---------------------------------------------------------------+
| ``DSCF``     | Select the |DSCF| algorithm from :cite:`Afisiadis2014`.        |
+--------------+---------------------------------------------------------------+
...
Corresponds to the ``T`` parameter of the |DSCF| decoding alogorithm
:cite:`Afisiadis2014`.
