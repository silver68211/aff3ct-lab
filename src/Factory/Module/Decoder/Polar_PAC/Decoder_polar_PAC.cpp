...
Decoder_polar_PAC ::get_description(cli::Argument_map_info& args) const
{
    ...
    tools::add_arg(args, p, class_name + "p+node-type", cli::Text(cli::Including_set("MS", "SPA")));
}
...
Decoder_polar_PAC ::build(const tools::Polar_code& code,
                         ...
                         module::Encoder<B>* encoder) const
{
    ...
    {
        std::vector<std::vector<std::function<Q(const std::vector<Q>& LLRs, const std::vector<B>& bits)>>> lambdas(
          code.get_kernel_matrices().size());
        ...
        for (size_t l = 0; l < lambdas.size(); l++)
        {
            ...
            if (this->node_type == "MS")
                lambdas[l] =
                  tools::Polar_lambdas<B, Q, tools::square_plus_MS<Q>>::functions[code.get_kernel_matrices()[l]];
            else if (this->node_type == "SPA")
                lambdas[l] =
                  tools::Polar_lambdas<B, Q, tools::square_plus_SPA<Q>>::functions[code.get_kernel_matrices()[l]];
        }
        return new module::Decoder_polar_PAC_SCL_naive<B, Q>(this->K, this->N_cw, this->L, code, frozen_bits, lambdas);
        ...
        /*        {*/
        /*            if (this->type == "SCL")*/
        /*                return new module::Decoder_polar_MK_SCL_naive_CA<B, Q>(*/
        /*                  this->K, this->N_cw, this->L, code, frozen_bits, lambdas, *crc);*/
        /*            if (this->type == "ASCL")*/
        /*                return new module::Decoder_polar_MK_ASCL_naive_CA<B, Q>(*/
        /*                  this->K, this->N_cw, this->L, code, frozen_bits, lambdas, *crc);*/
        /*        }*/
        /*        if (this->type == "SC")*/
        /*            return new module::Decoder_polar_MK_SC_naive<B, Q>(this->K, this->N_cw, code, frozen_bits, lambdas);*/
        /*        if (this->type == "SCL")*/
        /*            return new module::Decoder_polar_MK_SCL_naive<B, Q>(*/
        /*              this->K, this->N_cw, this->L, code, frozen_bits, lambdas);*/
        /*    }*/
        /*}*/
        ...
        /*        {*/
        /*            if (this->type == "SCL")*/
        /*                return new module::Decoder_polar_MK_SCL_naive_CA_sys<B, Q>(*/
        /*                  this->K, this->N_cw, this->L, code, frozen_bits, lambdas, *crc);*/
        /*            if (this->type == "ASCL")*/
        /*                return new module::Decoder_polar_MK_ASCL_naive_CA_sys<B, Q>(*/
        /*                  this->K, this->N_cw, this->L, code, frozen_bits, lambdas, *crc);*/
        /*        }*/
        /*        if (this->type == "SC")*/
        /*            return new module::Decoder_polar_MK_SC_naive_sys<B, Q>(*/
        /*              this->K, this->N_cw, code, frozen_bits, lambdas);*/
        /*        if (this->type == "SCL")*/
        /*            return new module::Decoder_polar_MK_SCL_naive_sys<B, Q>(*/
        /*              this->K, this->N_cw, this->L, code, frozen_bits, lambdas);*/
        /*    }*/
        /*}*/
    }
