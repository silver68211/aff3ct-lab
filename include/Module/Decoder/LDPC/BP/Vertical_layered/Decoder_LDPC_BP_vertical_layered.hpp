...
class Decoder_LDPC_BP_vertical_layered
  ...
  , public Decoder_LDPC_BP
{
  ...
  public:
    Decoder_LDPC_BP_vertical_layered(const int K,
                                     const int N,
                                     const int n_ite,
    ...
    virtual Decoder_LDPC_BP_vertical_layered<B, R, Update_rule, Syndrome_checker>* clone() const;
