...
Encoder ::Encoder(const std::string& prefix)
  : Factory(Encoder_name, Encoder_name, prefix)
{
}

Encoder ::Encoder(const std::string& name, const std::string& prefix)
...
Encoder ::get_description(cli::Argument_map_info& args) const
{
    ...
    tools::add_arg(args, p, class_name + "p+type", cli::Text(cli::Including_set("AZCW", "COSET", "USER")));
...
void
Encoder ::get_headers(std::map<std::string, tools::header_list>& headers, const bool full) const
{
    auto p = this->get_prefix();
...
template aff3ct::module::Encoder<B_8>*
aff3ct::factory::Encoder::build<B_8>() const;
template aff3ct::module::Encoder<B_16>*
aff3ct::factory::Encoder::build<B_16>() const;
template aff3ct::module::Encoder<B_32>*
aff3ct::factory::Encoder::build<B_32>() const;
template aff3ct::module::Encoder<B_64>*
aff3ct::factory::Encoder::build<B_64>() const;
#else
template aff3ct::module::Encoder<B>*
aff3ct::factory::Encoder::build<B>() const;
#endif
// ==================================================================================== explicit template instantiation
