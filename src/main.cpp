...
print_version()
{
    ...
    std::cout << "Copyright (c) 2016-2026 - MIT license." << std::endl;
...
int
read_arguments(const int argc, const char** argv, factory::Launcher& params)
{
    ...
    if (params.display_version) print_version();
...
main(int argc, char** argv)
{
    ...
    if (read_arguments(argc, (const char**)argv, params) == EXIT_FAILURE) return EXIT_FAILURE;
