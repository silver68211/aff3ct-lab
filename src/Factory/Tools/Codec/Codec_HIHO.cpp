...
Codec_HIHO ::Codec_HIHO(const std::string& prefix)
  : Codec(Codec_HIHO_name, prefix)
{
}

Codec_HIHO ::Codec_HIHO(const std::string& name, const std::string& prefix)
  : Codec(name, prefix)
{
}

template<typename B, typename Q>
tools::Codec_HIHO<B, Q>*
Codec_HIHO ::build(const module::CRC<B>* crc) const
{
...
template aff3ct::tools::Codec_HIHO<B_8, Q_8>*
aff3ct::factory::Codec_HIHO::build<B_8, Q_8>(const aff3ct::module::CRC<B_8>*) const;
template aff3ct::tools::Codec_HIHO<B_16, Q_16>*
aff3ct::factory::Codec_HIHO::build<B_16, Q_16>(const aff3ct::module::CRC<B_16>*) const;
template aff3ct::tools::Codec_HIHO<B_32, Q_32>*
aff3ct::factory::Codec_HIHO::build<B_32, Q_32>(const aff3ct::module::CRC<B_32>*) const;
template aff3ct::tools::Codec_HIHO<B_64, Q_64>*
aff3ct::factory::Codec_HIHO::build<B_64, Q_64>(const aff3ct::module::CRC<B_64>*) const;
#else
template aff3ct::tools::Codec_HIHO<B, Q>*
aff3ct::factory::Codec_HIHO::build<B, Q>(const aff3ct::module::CRC<B>*) const;
#endif
// ==================================================================================== explicit template instantiation
