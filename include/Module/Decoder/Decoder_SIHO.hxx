...
spu::runtime::Task&
Decoder_SIHO<B, R>::operator[](const dec::tsk t)
{
...
template<typename B, typename R>
spu::runtime::Socket&
Decoder_SIHO<B, R>::operator[](const dec::sck::decode_hiho s)
{
...
template<typename B, typename R>
spu::runtime::Socket&
Decoder_SIHO<B, R>::operator[](const dec::sck::decode_hiho_cw s)
{
...
template<typename B, typename R>
spu::runtime::Socket&
Decoder_SIHO<B, R>::operator[](const dec::sck::decode_siho s)
{
...
template<typename B, typename R>
spu::runtime::Socket&
Decoder_SIHO<B, R>::operator[](const dec::sck::decode_siho_cw s)
{
  ...
  , Y_N(N * this->get_n_frames_per_wave())
{
    ...
    this->create_codelet(
      p2,
      [p2s_Y_N, p2s_CWD, p2s_V_N](spu::module::Module& m, spu::runtime::Task& t, const size_t frame_id) -> int
      {
          auto& dec = static_cast<Decoder_SIHO<B, R>&>(m);
...
int
Decoder_SIHO<B, R>::decode_siho(const std::vector<R, AR>& Y_N,
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::decode_siho(const R* Y_N, int8_t* CWD, B* V_K, const int frame_id, const bool managed_memory)
{
    (*this)[dec::sck::decode_siho::Y_N].bind(Y_N);
    (*this)[dec::sck::decode_siho::CWD].bind(CWD);
    (*this)[dec::sck::decode_siho::V_K].bind(V_K);
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::decode_siho(const R* Y_N, B* V_K, const int frame_id, const bool managed_memory)
{
    (*this)[dec::sck::decode_siho::Y_N].bind(Y_N);
...
template<class AR, class AB>
int
Decoder_SIHO<B, R>::decode_siho_cw(const std::vector<R, AR>& Y_N,
                                   std::vector<int8_t, AB>& CWD,
                                   std::vector<B, AB>& V_N,
                                   const int frame_id,
                                   const bool managed_memory)
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::decode_siho_cw(const R* Y_N, int8_t* CWD, B* V_N, const int frame_id, const bool managed_memory)
{
    (*this)[dec::sck::decode_siho_cw::Y_N].bind(Y_N);
    (*this)[dec::sck::decode_siho_cw::CWD].bind(CWD);
    (*this)[dec::sck::decode_siho_cw::V_N].bind(V_N);
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::decode_siho_cw(const R* Y_N, B* V_N, const int frame_id, const bool managed_memory)
{
    (*this)[dec::sck::decode_siho_cw::Y_N].bind(Y_N);
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::_decode_siho(const R* Y_N, int8_t* CWD, B* V_K, const size_t frame_id)
{
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::_decode_siho_cw(const R* Y_N, int8_t* CWD, B* V_N, const size_t frame_id)
{
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::_decode_hiho(const B* Y_N, int8_t* CWD, B* V_K, const size_t frame_id)
{
...
template<typename B, typename R>
int
Decoder_SIHO<B, R>::_decode_hiho_cw(const B* Y_N, int8_t* CWD, B* V_N, const size_t frame_id)
{
    for (size_t i = 0; i < (size_t)this->N * this->get_n_frames_per_wave(); i++)
        this->Y_N[i] = Y_N[i] ? (R)-1 : (R)1;
...
template<typename B, typename R>
void
Decoder_SIHO<B, R>::set_n_frames_per_wave(const size_t n_frames_per_wave)
{
